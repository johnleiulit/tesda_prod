    ...
    <div class="container">
                    ...
                    <table class="table mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $application->title_ofAssessment_applied_for ?? $application->title_of_assessment_applied_for }}
                                </td>
                            </tr>
                            <tr>
                                <th>Full Name</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($application->fathers_name)
                                        | Father: {{ $application->fathers_name }}
                                    @endif
                                </td>
                            </tr>
                            <tr>
        ...
        @if ($application->status === \App\Models\Application::STATUS_PENDING)
            <form method="POST" action="{{ route('admin.applications.approve', $application) }}" class="d-inline">
                @csrf
                <button class="btn btn-success" onclick="return confirm('Approve this application?')">Approve</button>
            </form>
